...
public interface IDAO {
    ...
    boolean insertAuthor(Author a) throws SQLException, IllegalAccessException;
    ...
    boolean insertBook(Book b) throws SQLException, IllegalAccessException;
    ...
    boolean insertReader(Reader r) throws SQLException, IllegalAccessException;
    ...
    boolean insertSubscription(Subscription s) throws SQLException, IllegalAccessException;
